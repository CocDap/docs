...
<Card title="Add Content With MDX" icon="file" href="/essentials/telegram-bot">
...
<Card
  title="Telegram Bot"
  icon="square-code"
  href="/essentials/telegram-bot"
>
  Build a Telegram bot that interacts with the Polkadot network.
</Card>
